		...
		apply_filters('etimeclockwp_settings_general_tab', array(
			...
			array(
				...
				array(
					...
					'type' 			=> 'date',
					'default'		=> 'n/j/Y',
					'help'          => 'If you find the date listed here incorrect, please check your WordPress and server settings.',
				),
				array(
					...
					'type' 			=> 'time',
					'default'		=> 'g:i:s A',
					'help' 			=> 'If you find the time listed here incorrect, please check your WordPress and server settings.',
				),
			),
		)),
