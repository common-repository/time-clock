		...
		'pro_version' => array(
			...
			<div class='show-bullets'>
				<ul>
					...
					<li>Link a WordPress account to a Time Clock Account so users don't have to manually login each time</li>
				...
				<center>
					<a target='_blank' href='https://wpplugin.org/downloads/time-clock-pro/?utm_source=plugin-settings-page&utm_medium=plugin&utm_campaign=etimeclockwp_settings_page' class='button-primary' style='font-size: 17px;line-height: 28px;height: 32px;'>Upgrade to the Pro version</a>
				</center>
			</div>
